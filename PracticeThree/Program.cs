...
string siteTitle = Configuration.GetSection("Titulo").Value;
string textPath = Configuration.GetSection("PatientDirectory").Value;
string logPath = Configuration.GetSection("LogDirectory").Value;
